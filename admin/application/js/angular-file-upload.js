...
app.directive('ngFileSelect', ['$parse', '$timeout', '$compile',
...
app.directive('ngFileDrop', ['$parse', '$timeout', '$location', function ($parse, $timeout, $location) {
    return {
        restrict: 'AEC',
        require: '?ngModel',
        link: function (scope, elem, attr, ngModel) {
...
app.directive('ngNoFileDrop', function () {
...
app.directive('ngFileDropAvailable', ['$parse', '$timeout', function ($parse, $timeout) {
