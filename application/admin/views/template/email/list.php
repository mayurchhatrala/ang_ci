...
<div class="wrapper-md" ng-controller="TemplateContentTableCtrl" >
    <div class="panel panel-default" >
        <div class="panel-heading">
            <div class="row padding-0 margin-0">
                <div class="pull-left text-lg">Email Template List</div>
                <div class="pull-right">
                    <a ui-sref="template.email.form" class="btn btn-default btn-sm btn-addon">
