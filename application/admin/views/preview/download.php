...
<html lang="en">
    ...
    <!-- FAVI-ICONS -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/ico/apple.icns">
    <link rel="shortcut icon" href="assets/ico/windows.ico">
    ...
    <header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="index.html" class="navbar-brand">Web Service Documentation</a>
            </div>
        </div>
    </header>
