<div class="bg-light lter b-b wrapper-md">
    <h1 class="m-n font-thin h3">Manage Admin Roles</h1>
    <div class="m-t-sm">
        <h5 class="m-n font-bold h5 text-uppercase text-dark text-xs">
            ...
            <span>Manage Admin Types</span>
        </h5>
    </div>
</div>
<div class="wrapper-md" ng-controller="AdminTypeTableCtrl" >
    <div class="panel panel-default" >
        <div class="panel-heading">
            <div class="row padding-0 margin-0">
                <div class="pull-left text-lg">Admin Roles List</div>
                <div class="pull-right">
                    <a ui-sref="app.permission.form" class="btn btn-default btn-sm btn-addon">
