 ...
 * @author Admin
 */
class Weeklyads extends CI_Controller {
    ...
    public function formData() {
        try {
             ...
             */
            $response = $this->weekly_model->getWeeklyAdsRecord($request->requestId, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function WeeklyAdsRecord() {
        try {
            $postdata = file_get_contents("php://input");
            $request = json_decode($postdata);
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->weekly_model->getWeeklyAdsRecord();
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function CategoryName() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->weekly_model->CategoryName($request, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function checkUserName() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->weekly_model->checkUserName($request, true);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
                $this->RESP = array(
    ...
    public function checkPhone() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->weekly_model->checkEmail($request, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function checkSubscribePackage() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->weekly_model->checkSubscribePackage($request, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    private function _addRecord($requestFor) {
        try {
            if ($requestFor !== '') {
                 ...
                 */
                return $this->weekly_model->addRecord($requestFor, $request);
            } return false;
        } catch (Exception $ex) {
    ...
    private function _deleteRecord($requestFor, $requestId) {
        try {
            if ($requestFor !== '' && $requestId !== '') {
                return $this->weekly_model->deleteRecord($requestFor, $requestId);
            } return false;
        } catch (Exception $ex) {
    ...
    private function _updateRecord($requestFor, $requestId) {
        try {
            if ($requestFor !== '' && $requestId !== '') {
                 ...
                 * SAVE IN THE DATABASE
                 */
                return $this->weekly_model->updateRecord($requestFor, $request, $requestId);
            } return false;
        } catch (Exception $ex) {
    ...
    private function _activeRecord($requestFor, $requestId) {
        try {
            if ($requestFor !== '' && $requestId !== '') {
                 ...
                 * SAVE IN THE DATABASE
                 */
                return $this->weekly_model->activeRecord($requestFor, $postdata, $requestId);
            } return false;
        } catch (Exception $ex) {
            throw new Exception('Crud Controller : Error in _updateRecord function - ' . $ex);
        }
