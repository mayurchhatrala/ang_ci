...
class Retailer extends CI_Controller {
    ...
    public function formData() {
        try {
             ...
             */
            $response = $this->retailer_model->getRetailerRecord($request->requestId, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function RetailerRecord() {
        try {
            $postdata = file_get_contents("php://input");
            $request = json_decode($postdata);
            ...
            $response = $this->retailer_model->getRetailerRecord();
    ...
    public function RetailerList() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->retailer_model->RetailerList($request, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function checkUserName() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->retailer_model->checkUserName($request, true);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
                $this->RESP = array(
    ...
    public function checkPhone() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->retailer_model->checkEmail($request, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    public function checkSubscribePackage() {
        try {
             ...
             * TO CHECK THAT USERNAME AND PASSWORD ARE CORRECT OR NOT
             */
            $response = $this->retailer_model->checkSubscribePackage($request, true);
            //_print_r($response);
            if (!empty($response)) {
                $this->RESP = $response;
            } else {
    ...
    private function _addRecord($requestFor) {
        try {
            if ($requestFor !== '') {
                 ...
                 */
                return $this->retailer_model->addRecord($requestFor, $request);
            } return false;
        } catch (Exception $ex) {
    ...
    private function _deleteRecord($requestFor, $requestId) {
        try {
            if ($requestFor !== '' && $requestId !== '') {
                return $this->retailer_model->deleteRecord($requestFor, $requestId);
            } return false;
        } catch (Exception $ex) {
    ...
    private function _updateRecord($requestFor, $requestId) {
        try {
            if ($requestFor !== '' && $requestId !== '') {
                 ...
                 * SAVE IN THE DATABASE
                 */
                return $this->retailer_model->updateRecord($requestFor, $request, $requestId);
            } return false;
        } catch (Exception $ex) {
    ...
    private function _activeRecord($requestFor, $requestId) {
        try {
            if ($requestFor !== '' && $requestId !== '') {
                 ...
                 * SAVE IN THE DATABASE
                 */
                return $this->retailer_model->activeRecord($requestFor, $postdata, $requestId);
            } return false;
        } catch (Exception $ex) {
            throw new Exception('Crud Controller : Error in _updateRecord function - ' . $ex);
        }
